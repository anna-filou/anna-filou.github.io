...
! function(t) {
		...
		if (n) return function(t, e) {
			var n = t.element,
				...
				c = function(t, e, n) {
					...
					switch (r) {
						case h.i:
							return void 0 !== l && (v = B(v, k, g.B, l + a)), void 0 !== d && (v = B(v, M, g.C, d + c)), void 0 !== p && (v = B(v, C, g.D, p + f)), v;
						case h.k:
							return void 0 !== l && (v = B(v, L, g.u, l + a)), void 0 !== d && (v = B(v, P, g.v, d + c)), void 0 !== p && (v = B(v, D, g.w, p + f)), v;
						case h.j:
	...
	n(86), n(88), n(89), n(91), n(241), n(242), n(243), t.exports = n(244)
}, function(t, e, n) {
	var r = n(2);
		...
		function O(e, n) {
			...
			return n = n || {}, e.find(':input:not([type="submit"]):not([type="file"])').each(function(i, o) {
				...
				"string" == typeof s && (s = t.trim(s)), n[c] = s, r = r || function(t, e, n, r) {
					var i = null;
					"password" === e ? i = "Passwords cannot be submitted." : t.attr("required") ? r ? h.test(t.attr("type")) && (v.test(r) || (i = "Please enter a valid email address for: " + n)) : i = "Please fill out the required field: " + n : "g-recaptcha-response" !== n || r || (i = "Please confirm youâ€™re not a robot.");
					return i
				}(a, u, c, s)
			}), r
		}
	...
	var c = function(t, e) {
			...
			if (m && !y)
				for (var T = 0, k = u.length; T < k; T++) {
					...
					for (var C = (v - b) / w, L = m.config.easing, P = Object(a.a)(L, C), D = 0, R = u.length; D < R; D++) {
						var N = u[D],
							V = m.config[N],
							z = (y.config[N] - V) * P + V;
						A[N] = z
	...
	e.a = (m(r = {}, p.z, N()), m(r, p.A, V()), m(r, p.d, N()), m(r, p.c, V()), m(r, p.p, N(!1)), m(r, p.o, V(!1)), m(r, p.B, N()), m(r, p.C, V()), m(r, p.f, {
			...
			switch (u) {
				...
				case p.q:
					var k = C(),
						...
						P = k.scrollWidth,
						D = k.scrollHeight;
					S = E ? Math.min(M + x, P) / P : Math.min(L + O, D) / D;
					break;
				case p.g:
				default:
					A = Object(l.i)(o, s);
		...
		handler: function(t) {
			...
			var M = Object(l.i)(i, w),
				...
				D = (O ? A : 0) / 100;
			P = x ? P : 1 - P, D = _ ? D : 1 - D;
			var R = L.top + Math.min(L.height * P, v),
				N = L.top + L.height * D - R,
				V = Math.min(v + N, m),
